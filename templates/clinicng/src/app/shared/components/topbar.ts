          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <div class="relative shrink-0" id="notification-container">
              <button 
                ...
                <span class="absolute top-2.5 right-2.5 w-1.5 h-1.5 rounded-full bg-emerald-500 border border-theme-border"></span>
              </button>
              ...
              <div 
                ...
                <div class="px-4 py-2.5 border-b border-theme-border font-display font-medium text-xs text-theme-text-muted flex justify-between items-center">
                  ...
                  <span class="text-[9px] bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 px-1.5 py-0.5 rounded font-medium border border-emerald-500/20">3 New</span>
                </div>
                ...
                <div class="divide-y divide-theme-border text-xs font-normal">
                  <div class="px-4 py-3 hover:bg-theme-hover transition-colors cursor-default">
                    <p class="leading-normal"><span class="font-medium text-theme-text-main">Emergency:</span> Patient James Morrison admitted to ICU — cardiac event.</p>
                    <p class="text-[9px] text-theme-text-muted mt-1">12 minutes ago</p>
                  </div>
                  <div class="px-4 py-3 hover:bg-theme-hover transition-colors cursor-default">
                    <p class="leading-normal"><span class="font-medium text-theme-text-main">Lab Results:</span> Blood panel for batch #B-2847 ready for review.</p>
                    <p class="text-[9px] text-theme-text-muted mt-1">1 hour ago</p>
                  </div>
                  <div class="px-4 py-3 hover:bg-theme-hover transition-colors cursor-default">
                    <p class="leading-normal"><span class="font-medium text-theme-text-main">Reminder:</span> Staff meeting at 3:00 PM in Conference Room A.</p>
...
export class TopbarComponent {
  ...
  protected readonly activeNavName = computed(() => {
    ...
    if (url.startsWith('/appointments')) return 'Appointments';
    return 'Dashboard';
  });
