...
@Component({
  ...
  template: `
    <header 
      [class]="isDark() ? 'bg-zinc-950/40 border-zinc-850' : 'bg-white/40 border-zinc-200'" 
        ...
        <div class="flex items-center gap-3 w-full animate-blur-slide">
          <div 
            ...
            <input 
              ...
              placeholder="Search..." 
              class="bg-transparent border-none outline-none text-xs w-full placeholder-zinc-450 text-zinc-850 dark:text-zinc-200"
              autofocus>
          </div>
          <button 
        ...
        <div class="flex items-center justify-between w-full gap-4">
          ...
          <div class="flex items-center gap-3 shrink-0">
            <button 
              ...
              [class]="isDark() ? 'bg-zinc-900 border-zinc-850 text-zinc-300 hover:bg-zinc-800' : 'bg-white border-zinc-200 text-zinc-755 hover:bg-zinc-50'"
            ...
            <h1 class="font-display font-bold text-sm text-zinc-850 dark:text-zinc-105 select-none">
              {{ activeNav() }}
            </h1>
          </div>
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <div 
              ...
              <input 
                ...
                class="bg-transparent border-none outline-none text-xs w-full placeholder-zinc-450 text-zinc-855 dark:text-zinc-200">
              <kbd class="text-[8px] bg-zinc-100 dark:bg-zinc-800 text-zinc-400 px-1.5 py-0.5 rounded font-mono font-bold shrink-0">⌘ K</kbd>
            </div>

            <!-- Search Icon Toggle Button (visible only on mobile) -->
            <button 
              (click)="openMobileSearch()" 
              [class]="isDark() ? 'bg-zinc-900 border-zinc-850 text-zinc-350 hover:bg-zinc-800' : 'bg-white border-zinc-200 text-zinc-800 hover:bg-zinc-50'" 
            ...
            <div class="relative shrink-0 font-sans" id="notification-container">
              ...
              @if (isNotificationsOpen()) {
                <div 
                  ...
                  <div class="px-4 py-2.5 border-b font-display font-bold text-xs text-zinc-550 flex justify-between items-center" [class]="isDark() ? 'border-zinc-800' : 'border-zinc-100'">
                  ...
                  <div class="divide-y text-xs font-medium" [class]="isDark() ? 'divide-zinc-800' : 'divide-zinc-100'">
                    <div class="px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-850/60 transition-colors cursor-default">
                      <p class="leading-normal"><span class="font-bold text-teal-500">DK</span> completed <span class="font-semibold text-zinc-850 dark:text-zinc-50">Gantt Timeline Engine</span></p>
                      <p class="text-[9px] text-zinc-450 mt-1">10 minutes ago</p>
                    </div>
                    <div class="px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-850/60 transition-colors cursor-default">
                      <p class="leading-normal"><span class="font-bold text-teal-500">LN</span> bumped priority of <span class="font-semibold text-zinc-850 dark:text-zinc-50">Core API Auth</span> to High</p>
                  ...
                  <div class="p-2 border-t text-center" [class]="isDark() ? 'border-zinc-800' : 'border-zinc-100'">
            ...
            <button 
              ...
              [class]="isDark() ? 'bg-zinc-900 border-zinc-850 text-amber-400 hover:bg-zinc-800' : 'bg-white border-zinc-200 text-zinc-855 hover:bg-zinc-50'" 
...
export class TopbarComponent {
  ...
  public readonly themeChange = output<void>();
