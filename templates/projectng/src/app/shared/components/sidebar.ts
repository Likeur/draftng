...
@Component({
  ...
  template: `
    <aside 
      ...
      <div>
        <div class="flex items-center gap-3 overflow-hidden h-10 mb-8 select-none" [class.justify-center]="state.isCollapsed()">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 80 80" fill="none" id="Logo" class="shrink-0 select-none">
            <g id="logomark" [class]="state.isDark() ? 'fill-zinc-50' : 'fill-zinc-950'">
        ...
        <div class="mb-6">
          ...
          <nav class="space-y-1">
            ...
            <button 
              ...
              [class]="isActive('/dashboard') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
            ...
            <button 
              routerLink="/inbox"
              [class]="isActive('/inbox') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
              ...
              [class.px-2]="state.isCollapsed()"
              [class.px-3]="!state.isCollapsed()">
              <div class="flex items-center animate-fade-in" [class.gap-3]="!state.isCollapsed()">
            ...
            <button 
              routerLink="/projects"
              [class]="isActive('/projects') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
              class="w-full flex items-center py-2 rounded-lg text-xs transition-all cursor-pointer text-left overflow-hidden clickable-scale"
              [class.justify-center]="state.isCollapsed()"
              [class.gap-3]="!state.isCollapsed()"
              [class.px-2]="state.isCollapsed()"
            ...
            <button 
              routerLink="/todos"
              [class]="isActive('/todos') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
              class="w-full flex items-center py-2 rounded-lg text-xs transition-all cursor-pointer text-left overflow-hidden clickable-scale"
              [class.justify-center]="state.isCollapsed()"
              [class.gap-3]="!state.isCollapsed()"
              [class.px-2]="state.isCollapsed()"
            ...
            <button 
              routerLink="/calendar"
              [class]="isActive('/calendar') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
              class="w-full flex items-center py-2 rounded-lg text-xs transition-all cursor-pointer text-left overflow-hidden clickable-scale"
              [class.justify-center]="state.isCollapsed()"
              [class.gap-3]="!state.isCollapsed()"
              [class.px-2]="state.isCollapsed()"
            ...
            <button 
              routerLink="/employee"
              [class]="isActive('/employee') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
              class="w-full flex items-center py-2 rounded-lg text-xs transition-all cursor-pointer text-left overflow-hidden clickable-scale"
              [class.justify-center]="state.isCollapsed()"
              [class.gap-3]="!state.isCollapsed()"
              [class.px-2]="state.isCollapsed()"
            ...
            <button 
              routerLink="/team"
              [class]="isActive('/team') ? (state.isDark() ? 'bg-zinc-800/60 text-zinc-50 font-bold' : 'bg-zinc-200 text-zinc-900 font-bold') : 'text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-zinc-100/50 dark:hover:bg-zinc-800/30'" 
              class="w-full flex items-center py-2 rounded-lg text-xs transition-all cursor-pointer text-left overflow-hidden clickable-scale"
              [class.justify-center]="state.isCollapsed()"
              [class.gap-3]="!state.isCollapsed()"
              [class.px-2]="state.isCollapsed()"
      ...
      <div class="relative font-sans" id="user-menu-container">
              ...
              <div class="relative group/appearance w-full">
                ...
                <div 
                  ...
                  <div 
                    ...
                    <button (click)="selectTheme('light')" [class]="state.currentTheme() === 'light' ? (state.isDark() ? 'bg-zinc-850 text-zinc-50 font-bold' : 'bg-zinc-100 text-zinc-900 font-bold') : 'hover:bg-zinc-100/60 dark:hover:bg-zinc-800/60 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100'" class="w-full text-left px-2 py-1.5 rounded-lg text-xs font-semibold cursor-pointer transition-all clickable-scale">
                      Light
                    </button>
                    <button (click)="selectTheme('dark')" [class]="state.currentTheme() === 'dark' ? (state.isDark() ? 'bg-zinc-850 text-zinc-50 font-bold' : 'bg-zinc-100 text-zinc-900 font-bold') : 'hover:bg-zinc-100/60 dark:hover:bg-zinc-800/60 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100'" class="w-full text-left px-2 py-1.5 rounded-lg text-xs font-semibold cursor-pointer transition-all clickable-scale">
                      Dark
                    </button>
                    <button (click)="selectTheme('system')" [class]="state.currentTheme() === 'system' ? (state.isDark() ? 'bg-zinc-850 text-zinc-50 font-bold' : 'bg-zinc-100 text-zinc-900 font-bold') : 'hover:bg-zinc-100/60 dark:hover:bg-zinc-800/60 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100'" class="w-full text-left px-2 py-1.5 rounded-lg text-xs font-semibold cursor-pointer transition-all clickable-scale">
                      System
                    </button>
                  </div>
                </div>
        ...
        <button 
          ...
          [class]="state.isDark() ? 'hover:bg-zinc-800/60 hover:border-zinc-850 text-zinc-200' : 'hover:bg-zinc-50 hover:border-zinc-200 text-zinc-800'"
          ...
          <div class="flex items-center overflow-hidden shrink-0 font-sans" [class.gap-2]="!state.isCollapsed()">
...
export class SidebarComponent {
  ...
  protected isActive(path: string): boolean {
    ...
    // Exact match for dashboard, startswith for projects, etc.
    if (path === '/dashboard') {
