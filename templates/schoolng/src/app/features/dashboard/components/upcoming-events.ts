  ...
  template: `
    <div class="rounded-xl border bg-white dark:bg-zinc-100 border-zinc-200 dark:border-zinc-800/80 p-5 space-y-3">
      <div>
        ...
        <p class="text-[10px] text-zinc-400 dark:text-zinc-500 font-normal mt-1">Upcoming official assemblies and deadlines</p>
      </div>

      <div class="space-y-2.5">
        @for (evt of state.upcomingEvents(); track evt.id) {
          <div 
            class="p-3.5 rounded-xl border bg-white dark:bg-zinc-900/40 border-zinc-200/60 dark:border-zinc-800/60 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-200 animate-blur-slide clickable-scale font-sans">
            ...
            <div class="flex flex-col gap-1.5 text-[10px] text-zinc-400 dark:text-zinc-500 font-normal mt-2">
