...
@Component({
  ...
  template: `
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <!-- Total Students -->
      <div 
        class="p-4.5 rounded-xl border bg-white border-zinc-200 flex flex-col justify-between min-h-28 transition-colors duration-250 clickable-scale">
        <div class="flex items-center justify-between">
          <span class="text-[10px] font-medium text-zinc-400 tracking-wider capitalize">Total Students</span>
        ...
        <div class="mt-3">
          <h3 class="text-2xl font-medium tracking-tight text-zinc-900 leading-none">
      ...
      <div 
        class="p-4.5 rounded-xl border bg-white border-zinc-200 flex flex-col justify-between min-h-28 transition-colors duration-250 clickable-scale">
        <div class="flex items-center justify-between">
          <span class="text-[10px] font-medium text-zinc-400 tracking-wider capitalize">Active Classes</span>
          <div class="text-zinc-400">
            <!-- Lucide: school -->
      ...
      <div 
        class="p-4.5 rounded-xl border bg-white border-zinc-200 flex flex-col justify-between min-h-28 transition-colors duration-250 clickable-scale">
        <div class="flex items-center justify-between">
          <span class="text-[10px] font-medium text-zinc-400 tracking-wider capitalize">Teachers on Shift</span>
          <div class="text-zinc-400">
            <!-- Lucide: user-check -->
      ...
      <div 
        class="p-4.5 rounded-xl border bg-white border-zinc-200 flex flex-col justify-between min-h-28 transition-colors duration-250 clickable-scale">
        <div class="flex items-center justify-between">
          <span class="text-[10px] font-medium text-zinc-400 tracking-wider capitalize">Attendance Rate</span>
          <div class="text-zinc-400">
            <!-- Lucide: activity -->
