...
@Component({
  ...
  template: `
    <section class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <!-- Total Students -->
      <div 
        class="p-4.5 rounded-xl border bg-white dark:bg-zinc-100 border-zinc-200 flex flex-col justify-between min-h-28 transition-colors duration-250 clickable-scale">
        ...
        <div class="mt-3">
          ...
          <span class="text-[9px] font-normal text-zinc-400 dark:text-zinc-500 mt-1.5 block">
