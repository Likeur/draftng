...
@Component({
  ...
  template: `
    <div 
      class="rounded-xl border bg-white dark:bg-zinc-100 border-zinc-200 dark:border-zinc-800/80 p-5 space-y-3">
      <div>
        <h3 class="font-medium text-xs text-zinc-900 dark:text-zinc-50 tracking-wider capitalize">Console Shortcuts</h3>
        <p class="text-[10px] text-zinc-400 dark:text-zinc-500 font-normal mt-1">Registrar shortcuts for swift entries</p>
      </div>
