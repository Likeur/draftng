        ...
        <div class="flex items-center justify-between w-full gap-4">
          ...
          <div class="flex items-center gap-3 shrink-0">
            <button 
              ...
              [class]="state.isDark() ? 'bg-zinc-900 border-zinc-800 text-zinc-300 hover:bg-zinc-800' : 'bg-white border-zinc-200 text-zinc-700 hover:bg-zinc-50'"
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <button 
              ...
              [class]="state.isDark() ? 'bg-zinc-900 border-zinc-800 text-zinc-350 hover:bg-zinc-850' : 'bg-white border-zinc-200 text-zinc-800 hover:bg-zinc-50'" 
            ...
            <div class="relative shrink-0 font-sans" id="notification-container">
              <button 
                ...
                [class]="state.isDark() ? 'bg-zinc-900 border-zinc-800 text-zinc-355 hover:bg-zinc-850' : 'bg-white border-zinc-200 text-zinc-800 hover:bg-zinc-50'" 
                ...
                <span class="absolute top-2.5 right-2.5 w-1.5 h-1.5 rounded-full bg-amber-500"></span>
              </button>
              ...
              @if (isNotificationsOpen()) {
                <div 
                  ...
                  <div class="px-4 py-2.5 border-b font-display font-bold text-xs text-zinc-500 flex justify-between items-center" [class]="state.isDark() ? 'border-zinc-800' : 'border-zinc-100'">
                    <span>Notifications</span>
                    <span class="text-[9px] bg-amber-500/10 text-amber-500 px-1.5 py-0.5 rounded font-bold">2 Alerts</span>
                  </div>
                  ...
                  <div class="divide-y text-xs font-medium" [class]="state.isDark() ? 'divide-zinc-800' : 'divide-zinc-100'">
                    <div class="px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-850/60 transition-colors cursor-default">
                      <p class="leading-normal"><span class="font-bold text-amber-500">Notice:</span> Emergency weather evacuation drill scheduled for Wednesday morning.</p>
                      <p class="text-[9px] text-zinc-450 mt-1">1 hour ago</p>
                    </div>
                    <div class="px-4 py-3 hover:bg-zinc-50 dark:hover:bg-zinc-850/60 transition-colors cursor-default">
                      <p class="leading-normal"><span class="font-bold text-zinc-800 dark:text-zinc-50">Dr. Vance</span> updated roster for <span class="font-semibold text-zinc-800 dark:text-zinc-50">AP Calculus BC</span>.</p>
                  ...
                  <div class="p-2 border-t text-center" [class]="state.isDark() ? 'border-zinc-800' : 'border-zinc-100'">
                    <button (click)="markAllRead()" class="w-full py-1 text-[10px] font-bold text-amber-500 hover:text-amber-400 transition-colors cursor-pointer select-none clickable-scale">
                      Close Alerts Panel
                    </button>
                  </div>
                </div>
            ...
            <button 
              ...
              [class]="state.isDark() ? 'bg-zinc-900 border-zinc-800 text-amber-400 hover:bg-zinc-850' : 'bg-white border-zinc-200 text-zinc-800 hover:bg-zinc-50'" 
