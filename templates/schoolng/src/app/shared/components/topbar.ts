      ...
      @if (isSearchExpanded() && isMobileSearch()) {
        ...
        <div class="flex items-center gap-3 w-full animate-blur-slide">
          ...
          <button 
            ...
            class="text-xs font-medium px-2 py-2 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 cursor-pointer select-none shrink-0 clickable-scale">
            Cancel
          </button>
        </div>
      } @else {
        ...
        <div class="flex items-center justify-between w-full gap-4">
          ...
          <div class="flex items-center gap-3 shrink-0">
            <button 
              ...
              class="w-9 h-9 flex items-center justify-center bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-250 rounded-xl transition-all cursor-pointer select-none shrink-0 clickable-scale">
            ...
            <h1 class="font-display font-medium text-sm text-zinc-900 dark:text-zinc-50 select-none">
              {{ activeNavName() }}
            </h1>
          </div>
          ...
          <div class="flex items-center gap-2 shrink-0">
            ...
            <div class="relative shrink-0" id="notification-container">
              ...
              <div 
                ...
                class="absolute right-0 mt-2 w-80 bg-white dark:bg-zinc-955 border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-250 rounded-xl overflow-hidden py-1 z-50 shadow-lg transition-all duration-200 ease-out origin-top-right transform">
